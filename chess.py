...
def chess():
    ...
    #///////////////////////////////////////////////////
    parser.add_argument('--m', action='store', dest='x_dim', help='Board dimension in the x direction')
    parser.add_argument('--n', action='store', dest='y_dim', help='Board dimension in the y direction')
...
if __name__ == "__main__":
    ...
    try:
        ...
        if params:
            independence = Independence(params)
            independence.play()
